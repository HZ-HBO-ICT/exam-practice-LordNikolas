                            ...
                            <div class="card-content">
                                <div class="content">
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <input name="name" class="input @error('name') is-danger @enderror"
                                                   value="{{$foo->name}}" type="text" placeholder="Your name here...">
                                        </div>
                                        @error('name')
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea name="thud"
                                                      ...
                                                      type="text" placeholder="A short thud..."> {{$foo->thud}} </textarea>
                                        </div>
                                        @error('thud')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="field">
                                        ...
                                        <div class="control">
                                            <textarea name="wombat" class="textarea @error('wombat') is-danger @enderror"
                                                      rows="15" placeholder="The wombat of your foo..."> {{$foo->wombat}} </textarea>
                                        </div>
                                        @error('wombat')
                                        <p class="help is-danger">{{ $message }}</p>
                                        @enderror
